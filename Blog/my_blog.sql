DROP DATABASE IF EXISTS blog_p2p;

CREATE DATABASE blog_p2p CHARACTER SET 'utf8mb4';

USE blog_p2p;

/**
  ===============================================
  Partie donnée comme base au début de l'activité
  ===============================================
**/
-- Tables
...
-- Page de l'article
SELECT Article.titre AS 'Page de l\'article "4"'
FROM Article
WHERE Article.id = 4;
